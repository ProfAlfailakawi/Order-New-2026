...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} body{margin:0;padding:28px;background:#f3f4f6;font-family:'Cairo',Arial,sans-serif;color:var(--text);-webkit-print-color-adjust:exact;print-color-adjust:exact;}
    ...
    .footer{margin-top:22px;background:linear-gradient(145deg,#0d4b2c,#08371f);color:#fff;border:2px solid var(--gold);border-radius:18px;padding:18px;text-align:center;font-weight:800}.footer small{display:block;color:#e8d5a1;margin-top:4px;font-size:12px}.footer .legal-footer{color:rgba(232,213,161,.72);font-size:9px;font-weight:300;line-height:1.45}.no-print{margin-top:18px;text-align:center}.print-btn{border:0;border-radius:999px;background:var(--green);color:#fff;font-weight:900;padding:12px 28px;cursor:pointer;font-family:inherit}
...
<body>
  <main class="page">
    ...
    <footer class="footer">🌿 شكراً لتعاملكم معنا<small class="legal-footer">الاسم التجاري: ${LEGAL_TRADE_NAME_AR} | رقم السجل التجاري: ${COMMERCIAL_REGISTRATION_NUMBER}</small><small>Alturath.kw | 92225308 | 94059238</small></footer>
